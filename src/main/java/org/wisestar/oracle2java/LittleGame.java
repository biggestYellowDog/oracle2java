...
public class LittleGame {
    public static void main(String[] args)
    {
        ...
        while(true)
        {
            ...
            //胜利判定
            if(YingxHP<1) {
                System.out.println();System.out.println("勇者HP为0! 不..不可能..我怎么会..勇者倒下了。再接再厉吧！~");System.out.println();break;
            }
            if(MogHP<1) {
                System.out.println();System.out.println("恶龙HP为0! 恶龙绝望的哀鸣中倒了下去。勇者胜利了。恭喜你挑战成功！！");System.out.println();break;
            }
            ...
            //防御
            if(Do==3) {
                fangyu=1;System.out.println("你灵巧的躲避攻击！");
            }
            if(MogDo==1) {
                fangyu=1;System.out.println("恶龙进行防御！");
            }
            //角色判定
            if(Do==1&&YingxMP==0) {
            ...
            if(Do==1&&YingxMP>0) {
                if(fangyu==0) {
                    MogHP=MogHP-1;YingxMP=YingxMP-1;System.out.println("你发动攻击！");
                }
                if(fangyu==1) {
                    YingxMP=YingxMP-1;System.out.println("你的攻击被格挡！");
                }
            }
            if(Do==2) {
                YingxMP=YingxMP+1;System.out.println("你进行蓄力！");
            }
            if(Do==4&&YingxMP<3) {
                System.out.println("MP不足！");
            }
            if(Do==4&&YingxMP>2) {
                MogHP=MogHP-2;YingxMP=YingxMP-3;System.out.println("你发动重击！");
            }
            if(Do> 4) {
            ...
            if(MogDo==2&&MogMP>0) {
                if(fangyu==0) {
                    YingxHP=YingxHP-2;MogMP=MogMP-1;System.out.println("恶龙发动攻击！");
                }
                if(fangyu==1) {
                    MogMP=MogMP-1;System.out.println("恶龙的攻击被躲开了！");
                }
            }
            if(MogDo==0) {
                MogMP=MogMP+1;System.out.println("恶龙进行蓄力！");
            }
            if(MogDo==3&&MogMP<4) {
                System.out.println("恶龙在发呆！");
            }
            if(MogDo==3&&MogMP>3) {
                YingxHP=YingxHP-4;MogMP=MogMP-4;System.out.println("恶龙发动火焰吐吸！躲避不能！");
            }
            //结束
            fangyu = 0;
            MogDo = 0;
